...
class BaseNavigationController: UINavigationController {
    ...
    internal override class func initialize() {
        ...
        navBar.barTintColor = TBIThemeBlueColor//UIColor(r: 245, g: 80, b: 83)
...
//        viewController.hidesBottomBarWhenPushed = true
        ...
        if viewControllers.count > 0 {
            // push 后隐藏 tabbar
            viewController.hidesBottomBarWhenPushed = true
            viewController.navigationItem.leftBarButtonItem = UIBarButtonItem(image: UIImage(named: ""), style: .plain, target: self, action: #selector(navigationBackClick))
        }
