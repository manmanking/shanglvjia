//
//  FlightTripTransferView.swift
//  shanglvjia
//
//  Created by manman on 2018/4/3.
//  Copyright © 2018年 TBI. All rights reserved.
//

import UIKit

class FlightTripTransferView:UITableViewHeaderFooterView {
...
//    private let secondTripFlightTypeLabel:UILabel = UILabel()
    ...
    func setUIAutoLayout() {
        ...
        firstTripTakeoffHourLabel.font = UIFont.systemFont(ofSize: 16)
        ...
        firstTripArriveHourLabel.font = UIFont.systemFont(ofSize: 11)
        baseBackgroundView.addSubview(firstTripArriveHourLabel)
        firstTripArriveHourLabel.snp.makeConstraints { (make) in
            make.top.equalTo(firstTripTakeoffHourLabel.snp.bottom).offset(15)
        ...
        //第一段 航班状态
        firstTripFlightStatusLabel.textColor = TBIThemeBlueColor
...
//        firstTripMeaklCodeLabel.textAlignment = NSTextAlignment.center
//        baseBackgroundView.addSubview(firstTripMeaklCodeLabel)
//        firstTripMeaklCodeLabel.snp.makeConstraints { (make) in
//            make.centerY.equalTo(firstTripFlightTypeLabel)
//            make.right.equalTo(firstTripFirstLine.snp.left)
//            make.height.equalTo(15)
//            make.width.equalTo(60)
//        }
        ...
        transferMessageLabel.textColor = TBIThemeBlueColor
        ...
        secondTripTakeoffHourLabel.font = UIFont.boldSystemFont(ofSize:11)
        ...
        secondTripTakeoffAirportLabel.font = UIFont.systemFont(ofSize: 11)
        ...
        secondTripArriveHourLabel.font = UIFont.systemFont(ofSize: 16)
        baseBackgroundView.addSubview(secondTripArriveHourLabel)
        secondTripArriveHourLabel.snp.makeConstraints { (make) in
            make.top.equalTo(secondTripTakeoffHourLabel.snp.bottom).offset(15)
        ...
        // 第二段。航班状态
        secondTripFlightStatusLabel.textColor = TBIThemeBlueColor
        ...
        secondTripFlightCompanySHortNameLabel.snp.makeConstraints { (make) in
            make.top.equalTo(secondTripFlightStatusLabel)
...
//        secondTripMeaklCodeLabel.textAlignment = NSTextAlignment.center
//        baseBackgroundView.addSubview(secondTripMeaklCodeLabel)
//        secondTripMeaklCodeLabel.snp.makeConstraints { (make) in
//            make.centerY.equalTo(secondTripFlightTypeLabel)
//            make.right.equalTo(secondTripFirstLine.snp.left)
//            make.height.equalTo(15)
//            make.width.equalTo(60)
//        }
...
//        }
        ...
        secondTripTakeoffAirportLabel.text = (airfare.flightInfos.last?.takeOffAirportName ?? "") + (airfare.flightInfos.last?.takeOffTerminal  ?? "")!
        
        secondTripArriveAirportLabel.text = (airfare.flightInfos.last?.arriveAirportName ?? "") + (airfare.flightInfos.last?.arriveTerminal ?? "")
        ...
        if airfare.flightInfos.last?.share ?? false {
            ...
            secondTripFlightStatusLabel.text = "共享"
        }else
        {
