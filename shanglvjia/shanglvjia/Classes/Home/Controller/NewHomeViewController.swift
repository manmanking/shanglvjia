...
//        }
    ...
    func initData () {
        ...
        getLoopBannerImage()
        getTrainBookMaxDate()
        let bookMaxDate:NSNumber = NSNumber.init(value: 90 * 2)
        UserDefaults.standard.set(bookMaxDate, forKey: hotelBookMaxDate)
        UserDefaults.standard.set(bookMaxDate, forKey: personalHotelBookMaxDate)
