...
class CoOldOrderDetailsCellViewFlight: UITableViewCell {
    ...
    @objc private func showHideInfoClk()
    {
        ...
        cellShowHideListener.onShowHide(tableCell: self, flagStr: CoOldOrderDetailsCellViewFlight.FLIGHT_SHOWHIDE_DETAILS, indexPath: indexPath)
    ...
    {
        cellShowHideListener.onShowHide(tableCell: self, flagStr: CoOldOrderDetailsCellViewFlight.FLIGHT_LOOK_CHARGE, indexPath: indexPath)
    }
    
    //退改政策的查看详情的Label
    @objc private func changePolicyClk()
    {
        cellShowHideListener.onShowHide(tableCell: self, flagStr: CoOldOrderDetailsCellViewFlight.FLIGHT_CHANGE_POLICY, indexPath: indexPath)
    }
    
    //删除订单的btn
    @objc private func delOrderClk()
    {
        cellShowHideListener.onShowHide(tableCell: self, flagStr: CoOldOrderDetailsCellViewFlight.FLIGHT_DEL_ORDER, indexPath: indexPath)
    }
