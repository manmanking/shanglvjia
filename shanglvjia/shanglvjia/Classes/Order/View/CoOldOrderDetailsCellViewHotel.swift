...
class CoOldOrderDetailsCellViewHotel: UITableViewCell
{
    ...
    @objc private func showHideInfoClk()
    {
        ...
        cellShowHideListener.onShowHide(tableCell: self, flagStr: CoOldOrderDetailsCellViewHotel.HOTEL_SHOWHIDE_DETAILS, indexPath: indexPath)
    ...
    {
        cellShowHideListener.onShowHide(tableCell: self, flagStr: CoOldOrderDetailsCellViewHotel.HOTEL_DEL_ORDER, indexPath: indexPath)
    }
