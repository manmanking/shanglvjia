...
class CoOldOrderDetailsCellViewInsurance: UITableViewCell {
    ...
    {
        cellShowHideListener.onShowHide(tableCell: self, flagStr: CoOldOrderDetailsCellViewInsurance.INSURANCE_SHOWHIDE_DETAILS, indexPath: indexPath)
    ...
    {
        cellShowHideListener.onShowHide(tableCell: self, flagStr: CoOldOrderDetailsCellViewInsurance.INSURANCE_GIVE_MONEY, indexPath: indexPath)
    ...
    {
        cellShowHideListener.onShowHide(tableCell: self, flagStr: CoOldOrderDetailsCellViewInsurance.INSURANCE_DEL_ORDER, indexPath: indexPath)
