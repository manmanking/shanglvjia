//
//  PSepcialHotelDetailListCell.swift
//  shanglvjia
//
...
class PSepcialHotelDetailListCell: UITableViewCell {
...
//        }
    ...
    func fillSpecialHotelDataSources(model:SpecialHotelDetailResponse.RoomInfo,checkInDate:Date,checkOutDate:Date,index:NSInteger,payType:String,isShowProtocol:String){
        ...
        visaImageView.sd_setImage(with: URL.init(string: model.imageUrl), placeholderImage: UIImage(named: "hotel_default"))
...
//        }
        ...
        if specialHotelRoomPlanInfo.isFolderOpen{
...
//        }
        ...
        if normalHotelRoomPlanInfo.isFolderOpen {
            moreButton.isSelected = true
            moreView.isHidden = false
        }else{
            moreButton.isSelected = false
