...
class PersonalOrderListViewController: PersonalBaseViewController,UIWebViewDelegate {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        webView.loadRequest(URLRequest.init(url: URL.init(string:"\(Html_Base_Url)/static/testOrder/personalOrder/order_list.html?authorization=" + token + "&orderStatus=" + orderStatus)!))
    }
