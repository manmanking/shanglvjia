...
extension PTravelBookNextViewController:UITableViewDelegate,UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return section == 0 ? (adultCount + childCount) : 1
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if indexPath.section == 0{
            ...
            cell.fillCell(isBill:isBill,type:typeIndex,billName:"旅游费",billType:billTypeStr,typeArr:["电子发票","纸质发票"])
...
extension PTravelBookNextViewController{
    ...
    func nextOrder(sender: UIButton)
    {
        ...
        if isBill == true && typeIndex == 0 && personalName.value.isEmpty {
        ...
        if isBill{
            ...
            orderModel.expense.exKind = (billTypeStr == "电子发票" ? "0":"1")
