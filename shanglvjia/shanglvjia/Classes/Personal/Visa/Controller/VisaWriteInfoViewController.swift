...
class VisaWriteInfoViewController: PersonalBaseViewController,PayManagerStateProtocol {
    ...
    public var billTypeStr : String = "电子发票"
    ///是否同意条款
    ...
    func submitOrder(sender: UIButton) {
        ...
        for element in selectedPassengerArr {
            ...
            if visaMaxDate.compare(passportIdExpridDate) == .orderedDescending {
                var nameStr = element.chName.isEmpty ?  element.enNameFirst + element.enNameSecond : element.chName
        ...
        if isBill {
            ...
            expense.exKind = (billTypeStr == "电子发票" ? "0":"1")
...
extension VisaWriteInfoViewController:UITableViewDelegate,UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        return section == 2 ? peopleCount : 1
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if indexPath.section == 3{
            ...
            cell.fillDataSources(title: travelSuranceArr[indexPath.row].suranceName, content: "\(travelSuranceArr[indexPath.row].suranceSalePrice.floatValue)/人x \(selectedPassengerArr.count)份", isOpen: travelSuranceValueArr[indexPath.row], indexPathCell: indexPath.row)
            ...
            cell.fillCell(isBill:isBill,type:typeIndex,billName:"代办签证",billType:billTypeStr,typeArr:["电子发票","纸质发票"])
