...
class ScrollImagesDisplayView: UIView, UIScrollViewDelegate {
    ...
    fileprivate var buttonsArray: Array<ScrollImageViewButton> = []     //存储三个按钮
    ...
    fileprivate var pageControlHeight: CGFloat = 6
    ...
    fileprivate func initButtons() {
        for i in 0..<3 {
            let tempButton: ScrollImageViewButton = ScrollImageViewButton.init(frame: getButtonFrameWithIndex(i))
            tempButton.tag = i
