...
let IP_ADD = "http://60.28.158.166" //测试 环境
//let IP_ADD = "http://39.107.88.108" //正式 环境

//let IP_ADD = "http://tbi.btravelplus.com" //正式 环境


//let H5_Base_Url = "http://39.106.154.222:80" //正式 环境

// 测试环境
let H5_Base_Url = "http://60.28.158.166:10081"
