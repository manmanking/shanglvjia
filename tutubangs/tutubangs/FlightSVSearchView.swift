//
//  FlightSVSearchView.swift
//  shop
//
//  Created by manman on 2018/1/31.
...
class FlightSVSearchView: UIView,UITextFieldDelegate,UITableViewDataSource,UITableViewDelegate{
...
//    /// 多程 起始地点交换
//    typealias FlightSVSearchViewMoreTripExchangeAddressPointBlock  = (NSInteger)->Void
    
 //   public var flightSVSearchViewMoreTripExchangeAddressPointBlock:FlightSVSearchViewMoreTripExchangeAddressPointBlock!
    ...
    func setTableViewAutolayout() {
        ...
        moreTripTableView.register(FlightSearchTVTableViewCell.classForCoder(), forCellReuseIdentifier: tableViewCustomCellIdentify)
    ...
    private func setRouteBaseBackgroundViewAutolayout() {
        ...
        oneWayLabel.font = UIFont.systemFont(ofSize: 14)
        ...
        roundTripLabel.font = UIFont.systemFont(ofSize: 14)
    ...
    private func setDayBaseBackgroundViewAutolayout() {
        ...
        startDayWeekLabel.textColor = TBIThemePlaceholderColor
    ...
    private func setDaySubbaseRightDateBackgroundViewAutolayout() {
        ...
        endDayWeekLabel.textColor = TBIThemePlaceholderColor
    ...
    private func onewayAnimation() {
        ...
        UIView.animate(withDuration:0.3, delay: 0, options: UIViewAnimationOptions.curveEaseIn, animations: { () -> Void in
            ...
            case .OneWay?:
                weakSelf?.routeSelectedFlagImageView.image = UIImage(named: "ic_car_pickup")
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell:FlightSearchTVTableViewCell = tableView
            .dequeueReusableCell(withIdentifier: tableViewCustomCellIdentify) as! FlightSearchTVTableViewCell
        ...
        if tableViewDataSources.count + 1  == indexPath.row  {
            let cell:MoreTripTableViewAddCell = tableView
                .dequeueReusableCell(withIdentifier: tableViewAddCellIdentify)! as! FlightSVSearchView.MoreTripTableViewAddCell
            cell.selectionStyle = UITableViewCellSelectionStyle.none
   ...
   public func fillMoreTripDataSources(dataSoureces:[FlightSVSearchConditionModel]) {
    ...
    if  dataSoureces.first?.departureDate != 0 {
        ...
        //Date.init(timeIntervalSince1970: TimeInterval((dataSoureces.first?.departureDate)! / 1000)).string(custom: "EEE")
        //formatter.date(from:(dataSoureces.first?.departureDate)!)?.string(custom: "EEE")
        //serviceStartDate.string(custom: "EEE")
    }
    if  dataSoureces.first?.returnDate != 0 {
        ...
        //Date.init(timeIntervalSince1970: TimeInterval((dataSoureces.first?.returnDate)! / 1000)).string(custom: "MM月dd日")
            //formatter.date(from:(dataSoureces.first?.returnDate)!)?.string(custom: "MM月dd日")
        //serviceEndDate.string(custom: "MM月dd日")
        //endDayWeekLabel.text = Date.init(timeIntervalSince1970: TimeInterval((dataSoureces.first?.returnDate)! / 1000)).string(custom: "EEE")
        //formatter.date(from:(dataSoureces.first?.returnDate)!)?.string(custom:  "EEE")
        //serviceEndDate.string(custom: "EEE")
    }
    
//    if  defTakeOffStartHour.isEmpty == false{
//        startDayRightHourLebl.text = defTakeOffStartHour
//        hourStartHourLabel.text = defTakeOffStartHour
//    }else
//    {
//        hourStartHourLabel.text = "0:00"
//    }
//
//    if defLandingStartHour.isEmpty == false {
//        hourEndHourLabel.text = defLandingStartHour
//    }else
//    {
//        hourEndHourLabel.text = "0:00"
//    }
