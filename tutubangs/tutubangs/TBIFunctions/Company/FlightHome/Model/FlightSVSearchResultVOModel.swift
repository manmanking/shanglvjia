//
//  FlightSVSearchResultVOModel.swift
//  shanglvjia
//
...
class FlightSVSearchResultVOModel:  NSObject,ALSwiftyJSONAble,NSCoding {
...
//        return airfares.getAllCompanyCode()
//    }
//
    /// 获取此次查询的最低价格
//    var lowestPrice:Int {
//        return airfares.getLowestPrice()
//    }
//
    ...
    required init?(jsonData: JSON) {
        ...
        for element in airfaresCopy {
            ...
            for cabinsElement in element.cabins {
                cabinsElement.flightCacheId = element.cacheId
            }
    ...
    @objc(_TtCC10shanglvjia27FlightSVSearchResultVOModel9AirfareVO)class AirfareVO: NSObject ,ALSwiftyJSONAble,NSCoding{
        
        /// 是否被推荐 替换 false 无推荐 true 有推荐
        var hasRecommendFlightTrip:Bool = false
        
        /// 推荐航班
        var recommendFlightTrip:AirfareVO?
    ...
    @objc(_TtCC10shanglvjia27FlightSVSearchResultVOModel7CabinVO)class CabinVO: NSObject ,ALSwiftyJSONAble,NSCoding{
...
extension  Array where Element == FlightSVSearchResultVOModel.AirfareVO{
...
//        return self.reduce([]){all,airfare in
//            guard let code = airfare.legList.first?.marketAirlineCode,let name = flight.legList.first?.marketFlightName else {
//                return all
//            }
...
//        var flightArr:[Element] = Array()
//        for flightItem in self {
//            //let flight = flightItem
//            var cabins = flightItem.cabins
//            for element in flightItem.cabins {
//
//                if cabinType == element.shipping {
//                    flightArr.append(flightItem)
//                    break
//                }
//            }
//        }
