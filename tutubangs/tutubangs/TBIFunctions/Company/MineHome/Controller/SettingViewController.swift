...
let settingNomalCellIdentify = "settingNomalCellIdentify"

class SettingViewController: CompanyBaseViewController {

    fileprivate let bag = DisposeBag()
    fileprivate let tableView = UITableView()
    fileprivate let settingMessage = ["版本说明","修改企业密码","清除缓存"]
