//
//  CoNewTravelNoViewController.swift
//  shop
//
...
class CoNewTravelNoViewController: CompanyBaseViewController  {
    ...
    func submitTravel(sender: UIButton) {
        ...
        if travellerList.isEmpty{
            alertView(title: "错误",message: "请选择至少一个用户")
            return
        }
...
//            }
        ...
        showLoadingView()
        CoNewOrderService.sharedInstance.create(travelModel).subscribe{ event in
...
extension CoNewTravelNoViewController: UITableViewDelegate,UITableViewDataSource{
    ...
    func initTableView() {
        ...
        commitBtn.setTitle("创建", for: UIControlState.normal)
...
//            cell.fillCell(content: "成本中心", index: indexPath)
//            cell.selectionStyle = UITableViewCellSelectionStyle.none
