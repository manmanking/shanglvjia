...
enum PersonalFlightRouter {
    ...
    case personalFlightInvoices(productId:String,typeStr:String)///GET /gds/flight/query/invoiceAndSurance/{productId}/{orderType}
...
extension PersonalFlightRouter:TargetType{
    ...
    var path: String {
        ...
        case .personalFlightInvoices(let id,let type):
            return "/gds/flight/query/invoiceAndSurance/\(id)/\(type)"
        }
    }
