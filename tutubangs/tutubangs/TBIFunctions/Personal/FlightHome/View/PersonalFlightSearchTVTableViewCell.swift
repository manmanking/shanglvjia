//
//  PersonalFlightSearchTVTableViewCell.swift
//  shanglvjia
//
...
class PersonalFlightSearchTVTableViewCell: UITableViewCell {

    typealias FlightSearchTVTableViewCellServicesParametersTypeBlock = (PersonalFlightSVSearchView.FlightSVSearchViewServicesType,NSInteger) ->Void
    ...
    func setUIViewAutolayout() {
        ...
        showTripLebl.backgroundColor = PersonalThemeNormalColor
    ...
    @objc private func changeValue(sender:UITapGestureRecognizer) {
        ...
        case flightStartPointLabel:
            flightSearchTVTableViewCellServicesParametersTypeBlock(PersonalFlightSVSearchView.FlightSVSearchViewServicesType.startCity,cellIndex)
            break
        case flightEndPointLabel:
            flightSearchTVTableViewCellServicesParametersTypeBlock(PersonalFlightSVSearchView.FlightSVSearchViewServicesType.arriveCity,cellIndex)
            break
        case startDateDayLabel:
            flightSearchTVTableViewCellServicesParametersTypeBlock(PersonalFlightSVSearchView.FlightSVSearchViewServicesType.startDate,cellIndex)
            break
        default:
            break
        }
