...
class PHotelSearchViewController:  PersonalBaseViewController {
    ...
    func setUIViewAutolayout()
    {
        if PersonalBannerManager.shareInstance.getPersonalHotelBannerList().isEmpty == false {
            ...
            topImageView.sd_setImage(with:bannerUrl , placeholderImage: UIImage.init(named: "bg_default_travel"))
        }else {
            topImageView.sd_setImage(with:URL.init(string:"\(BASE_URL)/static/banner/subpage/hotel/ios/banner_hotel@3x.png"))
        }
