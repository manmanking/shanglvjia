//
//  PersonalHotelDetailRoomPlanMoreView.swift
//  shanglvjia
//
...
class PersonalHotelDetailRoomPlanMoreView: UIView {

    typealias PersonalHotelDetailRoomPlanSelectedBlock = (NSInteger)->Void
    ...
    public func fillDataSources(title:String,prices:String,index:NSInteger,productRemark:String,isShowProtocol:String,payType:String) {
        var titleStr = title
