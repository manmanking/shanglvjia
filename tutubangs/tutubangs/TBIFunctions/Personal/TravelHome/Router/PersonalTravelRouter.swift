...
enum PersonalTravelRouter {
    ...
    case personalTopicDetail(id:String)//GET /api/v1/travel/topic/{countryType}
}
...
extension PersonalTravelRouter:TargetType{
    ...
    var path:String{
        ...
        case .personalTopicDetail(let id):
            return "/api/v1/travel/topic/\(id)"
        }
    ...
    var method:Moya.Method{
        ...
        case .personalTravelList,.personalTravelOrder:
            return .post
        case .personalNearbyDetail,.personalTravelDetail,.personalTopicDetail:
            return .get
        }
    }
    /// 请求参数
    var parameters:[String:Any]?{
        ...
        case .personalTravelList(let params),.personalTravelOrder(let params):
            return params
        case .personalTravelDetail,.personalNearbyDetail,.personalTopicDetail:
            return nil
        }
    }
    /// 请求参数的发送方式
