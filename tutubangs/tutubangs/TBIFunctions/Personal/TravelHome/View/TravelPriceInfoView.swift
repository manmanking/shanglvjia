...
class TravelPriceInfoView: UIView {
    ...
    func setViewWithArray(dataArr:[(priceTitle:String,price:String)]){
        arr = dataArr
...
extension TravelPriceInfoView:UITableViewDelegate,UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.priceLabel.text = arr[indexPath.row].price
        cell.nameLabel.text = arr[indexPath.row].priceTitle
        return cell
    }
}
